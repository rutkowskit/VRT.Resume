...
{
    public partial class PersonResumeConfiguration : IEntityTypeConfiguration<PersonResume>
    {
        public void Configure(EntityTypeBuilder<PersonResume> entity)
        {
            entity.HasKey(e => e.ResumeId);

            entity.ToTable("PersonResume", "Resumes", tb => tb.HasComment("Person resume data"));

            entity.HasIndex(e => e.PersonId, "IX_PersonResume_PersonId");

            entity.Property(e => e.Description)
                .IsRequired()
                .HasMaxLength(50)
                .HasComment("Description of the resume (e.g. .net develper to asseco)")
                .HasDefaultValue("Resume", "DF_PersonResume_Description");
            ...
            entity.Property(e => e.ShowProfilePhoto)
                ...
                .HasDefaultValue(true, "DF_Resume_ShowProfilePhoto");
            entity.Property(e => e.Summary).HasComment("Profile summary text");

            entity.HasOne(d => d.Person).WithMany(p => p.PersonResume)
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<PersonResume> entity);
    }
}
