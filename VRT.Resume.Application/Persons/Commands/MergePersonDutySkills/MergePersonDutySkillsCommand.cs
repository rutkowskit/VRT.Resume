...
public sealed class MergePersonDutySkillsCommand : IRequest<Result>
{
        ...
        IRequestHandler<MergePersonDutySkillsCommand, Result>
    {
        ...
        private async Task<Result<PersonExperienceDuty>> GetDutyWithSkills(int personId, int dutyId)
        {
            var result = await Context.PersonExperienceDuty
